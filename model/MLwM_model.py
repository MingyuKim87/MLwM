...
from model.Part.encoder import Deterministic_Conv_Encoder, \
    Stochastic_Conv_Encoder, Conv_Reparameterization_Encoder
...
class MLwM(nn.Module):
    def __init__(self, encoder_config, maml_config, update_lr, update_step, initializer=None, \
        is_regression=False, is_kl_loss=False, beta_kl=1):
        super().__init__()
        ...
        self.maml = Meta(self.maml_config, update_lr, update_step, initializer=None, is_regression=self._is_regression)
